...
const logger = winston.createLogger({
    ...
    transports: [
      ...
      msg: 'HTTP {{req.method}} {{req.url}} {{req.body}} {{res.responseTime}}ms', // optional: customize the default logging message. E.g. "{{res.statusCode}} {{req.method}} {{res.responseTime}}ms {{req.url}}"
